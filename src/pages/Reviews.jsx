...
function Reviews() {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'dark' : ''}`}>
      ...
      <section className="pt-24 pb-16 bg-gradient-to-br from-yellow-400/10 to-yellow-500/10 dark:from-yellow-400/20 dark:to-yellow-500/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-surface-900 dark:text-white mb-6">
              Customer <span className="bg-gradient-to-r from-yellow-400 to-yellow-500 bg-clip-text text-transparent">Reviews</span>
            </h1>
            <p className="text-xl md:text-2xl text-surface-600 dark:text-surface-300 leading-relaxed">
              See what our guests are saying about their TableTaste experience. Read reviews and share your own dining story.
            </p>
          </motion.div>
        </div>
      </section>
